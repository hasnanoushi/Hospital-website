  ...
  return (
    <div>
      <div className="row">
        ...
        <div className="col-6">
          {" "}
          <h1 className="hi">Gastroentrology</h1>
          Gastroentrologist at HN Hospitals diagnose and treat a wide range of
          heart conditions <br />
          ...
          <br />
          The department of Gastroentrology has the best Gastroentrologist,
          technology, <br />
          ...
          Our Gastroentrology <br />
          department cater to all the subspecialties of Gastroentrology
          including diagnostic, <br />
          interventional,non-invasive, and surgical.
          <br />
        </div>
        <div className="col-5">
          <img src={gas} className="dept-img" />
        </div>
      </div>
      <div className="spec doctext">
        ...
        <div>
          <img src={d8} />
          <h4 className="f">Dr.Muhammed Irshad</h4>
          <h4 className="f">MBBS,MD in Gastroentrology</h4>
