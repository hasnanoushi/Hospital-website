...
export default function Home() {
  return (<>
    ...
    </a></div> <h1 className='serv-head'>OUR SERVICES</h1>
  <div className='serviceList'>
 
    <div className='service'>
   <img src={ICU} className="icon"/> 
    <h3 className='hd'>ICU</h3>
Our ICU services are at the core of <br/>many our life
 saving treatments.<br/> Patients are monitored round 
 the clock in <br/>sterile, infection safe environments.
    </div>
    <div className='service'>
...
timely and quality pre-hospital<br/>
 emergency care/interhospital<br/>
...
facilities make it possible to perform<br/>
...
Our fully equipped labs help doctors<br/>
 and specialists to administer <br/>
 based evidence based treatments<br/>
